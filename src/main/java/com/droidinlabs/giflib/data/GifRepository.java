package com.droidinlabs.giflib.data;
...
public class GifRepository {
    ...
    public static List<Gif> findByCategoryId(int id) {
    ...
    public static List<Gif> findByFavorite() {
    ...
    public static List<Gif> search(String name) {
        List<Gif> gifs = new ArrayList<>();
        for (Gif gif :
                ALL_GIFS) {
            if (gif.getName().toLowerCase().contains(name.toLowerCase())) {
                gifs.add(gif);
            }
